...
export default function Modal({ open, onClose, title, subtitle, children, size = 'md', footer }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
      ...
      >
        {title && (
          <div className="flex items-start justify-between px-6 py-4 border-b border-navy-100 flex-shrink-0">
            <div>
        ...
        {footer && (
          <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-navy-100 flex-shrink-0">
            {footer}
          </div>
        )}
      </div>
